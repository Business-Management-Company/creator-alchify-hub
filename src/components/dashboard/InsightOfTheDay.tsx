...
export function InsightOfTheDay({ insight, isLoading }: InsightOfTheDayProps) {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-r from-primary/10 via-accent/10 to-primary/10 border border-primary/20 hover:border-primary/40 rounded-2xl p-5 transition-all duration-300 group h-full">
